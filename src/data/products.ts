...
export type Product = { id?: number; nome: string; preco: number; descricao: string; categoria: string; destaque?: boolean; imageKey: ProductImageKey; };
...
export const products: Product[] = [
  ...
  { id: 3, nome: 'Mini Vaso Decorativo', preco: 24.9, descricao: 'Vaso moderno para mesa, escritório, quarto ou ambiente corporativo.', categoria: 'Casa', imageKey: 'vaso' },
  ...
  { id: 6, nome: 'Organizador de Cabos', preco: 18.9, descricao: 'Acessório prático para deixar fios, carregadores e setup organizados.', categoria: 'Utilidades', imageKey: 'cabos' },
  { id: 7, nome: 'Luminária Lunar 3D', preco: 89.9, descricao: 'Luminária decorativa com visual premium para quarto ou escritório.', categoria: 'Decoração', imageKey: 'luminaria' },
  { id: 8, nome: 'Suporte para Controle', preco: 39.9, descricao: 'Organizador para controle gamer, TV ou acessórios do setup.', categoria: 'Setup', imageKey: 'controle' },
];
